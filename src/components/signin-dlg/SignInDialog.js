              ...
              <Stack spacing={1}>
                ...
                <PaperRecord sx={{ p: 1.5 }}>
                  <Stack direction="row" alignItems="center" spacing={2}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" align="right" color="text.secondary"> USD {math.round(coinUSD * balance, 4)} 
                      </Typography>
                    </Box>
                  </Stack>
                </PaperRecord>
                <PaperRecord sx={{ p: 1.5 }}>
                  <Stack direction="row" alignItems="center" spacing={2}>
                    ...
                    <Box>
                      <Typography variant="body2" align="right"> 0 
                      </Typography>
                      <Typography variant="body2" align="right" color="text.secondary"> 0 
                      </Typography>
                    </Box>
                  </Stack>
                </PaperRecord>
