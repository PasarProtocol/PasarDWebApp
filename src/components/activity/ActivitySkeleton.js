...
import { Box, Stack, Divider, TableRow, TableCell, Accordion, AccordionSummary,useMediaQuery } from '@mui/material';
          ...
          <SkeletonTheme {...themeProp}>
            <Stack direction="row" spacing={1} alignItems="center" width="100%">
              ...
              <Box sx={{flexGrow: 1, lineHeight: '1.4em'}}>
                <h4><Skeleton style={{ borderRadius: '0.4rem' }}/></h4>
                <h4><Skeleton style={{ borderRadius: '0.4rem' }}/></h4>
                <h4><Skeleton style={{ borderRadius: '0.4rem' }}/></h4>
              </Box>
            </Stack>
