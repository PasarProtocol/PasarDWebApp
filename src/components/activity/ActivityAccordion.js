          ...
          <Stack flex={1} minWidth={0}>
            <Stack direction="row">
              <Box sx={{ minWidth: 0, flexGrow: 1 }}>
                <Link to={`/collections/detail/${trans.marketPlace}${trans.baseToken}`} component={RouterLink} sx={{ color: 'inherit', display: 'inline-flex', maxWidth: 'max-content', width: '100%' }}>
            ...
            <Stack direction="row">
              <Box sx={{ minWidth: 0, flexGrow: 1 }}>
                <Link to={`/marketplace/detail/${[trans.tokenId, trans.baseToken].join('&')}`} component={RouterLink} sx={{ color: 'inherit', display: 'inline-flex', maxWidth: 'max-content', width: '100%' }}>
