...
export const {
  ...
  elaOnEthContract,
  blockchain
} = process.env.REACT_APP_ENV === 'production' ? addressForProduction : addressForTest;
export const mainDiaContract = addressForProduction.diaContract;

export const ipfsURL =
  process.env.REACT_APP_ENV === 'production'
    ? process.env.REACT_APP_IPFS_URL_PRODUCTION
    : process.env.REACT_APP_IPFS_URL_TEST;
export const rpcURL = process.env.REACT_APP_ENV === 'production' ? rpcUrlForMain : rpcUrlForTest;
export const ExplorerServer =
  process.env.REACT_APP_ENV === 'production' ? NetworkExplorerServer.MainNet : NetworkExplorerServer.TestNet;
